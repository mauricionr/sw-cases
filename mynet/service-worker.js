...
var precacheConfig = [
  ["img/mynet-logo.png", "219095a3b3477f2d3e656446a3d59f72"]
];
var cacheName = 'sw-precache-v2-MobilAMP-' + (self.registration ? self.registration.scope : '');
...
toolbox.router.get(/\.mynet\.com\//, toolbox.networkFirst, {});
toolbox.router.get(/www\.googletagservices\.com\//, toolbox.networkFirst, {});
toolbox.router.get(/fonts\.gstatic\.com\//, toolbox.networkFirst, {});
